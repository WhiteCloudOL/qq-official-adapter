...
MAX_HEARTBEAT_INTERVAL_MS = 5 * 60 * 1000
...
MAX_MESSAGE_SEGMENTS = 100
MAX_OUTBOUND_MARKDOWN_CHARS = 4000
MAX_OUTBOUND_TEXT_CHARS = 20000
MAX_RUNTIME_STATE_ENTRIES = 10000
INBOUND_MESSAGE_DEDUP_TTL_SEC = 10 * 60
TRUSTED_QQ_MEDIA_HOSTS = frozenset(
    {
